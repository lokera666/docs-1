...
You can build a [custom image](/docs/agent/self-hosted/gcp/elastic-ci-stack/terraform#custom-images) if you need additional tools for your pipelines.
...
For more information, see the [Queues overview](/docs/agent/queues) page.
